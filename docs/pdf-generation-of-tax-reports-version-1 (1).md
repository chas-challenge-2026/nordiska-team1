...
# Databas
1) Skapa en tabell för TaxJob  
2) Skapa två triggers 

# Frontend

># **TaxReportJob (Service)**
>1)  Skapa en tom service för TaxReportJobService
>2) Skapa metoder -> 
...
>1)  Skapa en tom controller för TaxReportController
>2) Skapa en GET controller som hämtar status
>3) Skapa en GET controller som hämtar tax report
>4) utkommentera authentication
